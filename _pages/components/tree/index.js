...
<strong>When you load treeNodes asynchronously, you should render tree like this</strong>:

\`\`\`jsx {this.state.treeData.length ? &lt;Tree&gt;{this.state.treeData.map(data =&gt; &lt;TreeNode /&gt;)}&lt;/Tree&gt; : 'loading tree'}\`\`\`
`
const expComponent = () => (
        <div>
            <h4>Tree</h4>
